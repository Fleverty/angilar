...
@Component({
	...
	selector: "app-ewaybill-outbox-created",
	templateUrl: "./ewaybill-outbox-created.component.html",
	styleUrls: ["./ewaybill-outbox-created.component.scss"]
})

export class EwaybillOutboxCreatedComponent extends EwaybillReceiver {
	constructor(
