...
@Component({
	...
	selector: "app-ewaybill-outbox-created-cancel-sent",
	templateUrl: "./ewaybill-outbox-created-cancel-sent.component.html",
	styleUrls: ["./ewaybill-outbox-created-cancel-sent.component.scss"]
})

export class EwaybillOutboxCreatedCancelSentComponent extends EwaybillShipper {
	constructor(
