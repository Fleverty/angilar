...
@Component({
	...
	selector: "app-ewaybill-outbox-transferred",
	templateUrl: "./ewaybill-outbox-transferred.component.html",
	styleUrls: ["./ewaybill-outbox-transferred.component.scss"]
})

export class EwaybillOutboxTransferredComponent extends EwaybillShipper {
	constructor(
