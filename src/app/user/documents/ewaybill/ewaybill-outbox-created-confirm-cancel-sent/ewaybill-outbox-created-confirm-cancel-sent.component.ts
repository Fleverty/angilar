...
@Component({
	...
	selector: "app-ewaybill-outbox-created-confirm-cancel-sent",
	templateUrl: "./ewaybill-outbox-created-confirm-cancel-sent.component.html",
	styleUrls: ["./ewaybill-outbox-created-confirm-cancel-sent.component.scss"]
})

export class EwaybillOutboxCreatedConfirmCancelSentComponent extends EwaybillShipper {
	constructor(
