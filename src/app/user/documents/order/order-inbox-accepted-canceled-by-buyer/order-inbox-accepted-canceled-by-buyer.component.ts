...
@Component({
	selector: "app-order-inbox-accepted-canceled-by-buyer",
	templateUrl: "./order-inbox-accepted-canceled-by-buyer.component.html",
	styleUrls: ["../order-view.scss"],
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class OrderInboxAcceptedCanceledByBuyerComponent extends OrderSupplier {
	constructor(
		router: Router,
